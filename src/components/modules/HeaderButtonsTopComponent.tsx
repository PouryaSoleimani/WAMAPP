...
const HeaderButtonsTopComponent = () => {
    return (
        <div className='w-[85%] mx-auto my-6 flex items-center justify-center gap-5'>
            ...
            <Button className='bg-white text-black text-lg font-bold px-3 py-8 tracking-tighter rounded-lg  hover:bg-zinc-500 hover:text-white duration-500 cursor-pointer'>لیست وام دهنده ها</Button>
        </div>
    )
}
