...
const CategoryFlexBoxComponent: React.FC<CategoryFlexBoxComponentProps> = ({ id, title }) => {
    return (
        <div className='w-full h-auto border-2 border-blue-600  rounded-xl flex flex-col bg-[#DDE2E5] hover:scale-105 duration-500'>
            <img src={_Image} alt="image" width={140} className='rounded-t-lg' />
